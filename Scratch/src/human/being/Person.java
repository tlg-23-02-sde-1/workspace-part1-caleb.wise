 ...
 * in such a way that instance of it (Person objects) cannot have their
 * properties changed once created. In short: getters no setters.
 */
class Person {
     ...
     *
     * This can be derived from the birtDate and today's date.
